...
The data we're working with is from the OpenIntro site: `https://www.openintro.org/data/csv/hfi.csv`. Here is the "about" page: <https://www.openintro.org/data/index.php?data=hfi>. I have downloaded this file and it is available to you in your Day 1 directory (`activity02-slr/day01-fitting`).
